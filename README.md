...
Temel ne kadar sade ve temiz olursa, o temelin üzerinde koşan "beyin" (AI denetçisi) o kadar esnek, hızlı ve güçlü olur. Tıpkı temel Lego parçalarının (tabloların) çok basit olması, ama onlarla devasa ve karmaşık yapılar (benim "Kolini Ağı"nız) inşa edebilmem gibi.
